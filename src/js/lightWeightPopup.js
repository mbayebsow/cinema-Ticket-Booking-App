...
(function($){
    $.fn.lightWeightPopup = function(options) {
        ...
        $(this).on("click",function(){
            ...
            if(settings.top!=''){
                spt     =   'top:'+settings.top+';';
            }
             
            $("body").append('<div class="lwp-overlay" '+setOL+'></div><div class="lwp" tabindex="-1" role="dialog" style="'+sw+' '+sh+' '+smw+' '+smh+' '+spt+'"><div class="closeModal" onclick="closeDilog(\''+dset.content+'\')"><span>×</span></div><div id="lwp" style="'+setIFH+'"><div id="lwpHead"></div><div id="lwpBody" role="document" '+setMF+'><div class="loading"><img src="../src/img/loader.gif"></div></div></div></div>');
            ...
            if(dset.content=='iframe'){
                ...
                setTimeout(function(){ $('#lwpBody').html('<iframe frameborder="0" style="height:'+bh+'px; width:100%;" src="'+settings.href+'" onload="close_frame()"></iframe>');},1000);
            }
